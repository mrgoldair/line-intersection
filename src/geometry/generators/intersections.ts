 ...
 */
 ...
 import { minTraverse } from "../../traverse";
...
type SweepLine = {
  ...
  */
 export default function* intersections(segments:Array<Segment>) {
   ...
   while( queue.peek() != undefined ){
     ...
     switch (event.type) {
       case "start": {
         ...
         let { desc, segment, position } = event as Endpoint
         ...
         yield {
          ...
          segments: minTraverse( sweepline.root ),
          points: position
         }
       ...
       case "intersect": {
         ...
         // TODO - We only need two of these tests, not four
